...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '24KMag1c', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '持续摆烂ing', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.24kmag1c.fun', // 网站地址
